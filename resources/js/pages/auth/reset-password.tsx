...
export default function ResetPassword({ token, email }: Props) {
    ...
    return (
        <>
            <Head title="Reset Password | IdeaForge" />
            <div className="min-h-screen flex items-center justify-center p-4" style={{ backgroundColor: '#fcf9f5' }}>
                <main className="w-full max-w-md">
                    ...
                    <div className="bg-white rounded-xl p-8 border border-outline-variant/30 shadow-sm">
                        <h2 className="text-2xl font-semibold text-on-surface mb-2">Set new password</h2>
                        <p className="text-sm text-on-surface-variant mb-6">Choose a strong password for your account.</p>

                        <form onSubmit={submit} className="space-y-5">
                            {/* Hidden token — sent to server with the form */}
                            ...
                            <div className="flex flex-col gap-1">
                                <label htmlFor="password" className="text-sm font-semibold text-on-surface-variant">New Password</label>
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-10 pr-4 py-3 rounded-lg border border-outline-variant bg-white text-on-surface outline-none focus:ring-2 focus:ring-primary-container focus:border-primary"
                                        required
                                    />
                                </div>
                            ...
                            <div className="flex flex-col gap-1">
                                <label htmlFor="password_confirmation" className="text-sm font-semibold text-on-surface-variant">Confirm Password</label>
                                <div className="relative">
                                    <span className="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-outline text-xl">lock</span>
                                    <input
